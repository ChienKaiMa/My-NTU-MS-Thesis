\begin{table}[htbp]
    ...
    \caption{Comparison of quantum circuit synthesis methods for
        discriminating three coherent states.
        Here 2Q means the number of two-qubit gates, which is
        also the number of CNOT gates in this case.
        The numbers for the state fidelity and process fidelity are rounded down to the fifth digit.}
    ...
    \scalebox{0.45}{
        ...
        \begin{tabular}{|c|c||rr||rrr|rrr|rrr|rrr|}
            \hline
            \textbf{\# Qubits}
              & \multicolumn{1}{c||}{\textbf{State Fidelity}}
              ...
              &                                                          & Depth & 2Q    & Depth & 2Q   & Process Fidelity & Depth & 2Q   & Process Fidelity & Depth & 2Q   & Process Fidelity & Depth & 2Q & Process Fidelity \\
            \hline
