...
\ntusetup{
  ...
  keywords*     = {unambiguous quantum state discrimination (UQSD), quantum circuits, positive operator-valued measure (POVM), depolarizing noise},
}
...
% Other macros
\newcommand{\lSDP}{\lambda_{\mathrm{SDP}}}
\newcommand{\leval}{\lambda_{\mathrm{eval}}}
\newcommand{\clb}{c_{\mathrm{lb}}} % FRIO lower-bound parameter (label, upright)
