...
\ntusetup{
  ...
  title*        = {Quantum Circuit Design Automation for Quantum State Discrimination of Arbitrary Number of States},
  author        = {馬健凱},
  author*       = {Chien-Kai Ma},
  ID            = {R11943106},
  advisor       = {江介宏},
  advisor*      = {Jie-Hong Roland Jiang},
  date          = {2024-07-23},         % 若註解掉，則預設為當天
  oral-date     = {2024-07-23},         % 若註解掉，則預設為當天
